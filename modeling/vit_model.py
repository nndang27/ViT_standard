...
class PositionalEmbedding1D(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("POS SHAPE: ", self.pos_embedding.shape)
...
class ViT(nn.Module):
    ...
    def __init__(
        ...
        # Transformer
        self.transformer = TransformerEncoderBlock(num_layers=num_layers, dim=dim, num_heads=num_heads, 
    ...
    def forward(self, x):
        ...
        # print("SHAPE BEFORE CLASS: ", x.shape)
        if hasattr(self, 'class_token'):
            x = torch.cat((self.class_token.expand(b, -1, -1), x), dim=1)  # b,gh*gw+1,d
        # print("SHAPE BEFORE POS: ", x.shape)
